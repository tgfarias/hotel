                                ...
                                <div class="layout-cell content">
                                    <div class="box post">
                                        <div class="box-body post-body">
                                            ...
                                            <form name="form_login" action="<?=site_url('admin/index/dologin');?>" method="POST">
                                                <table border="0" width="500" align="center">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td width="60"></td>
                                                            <td><h1 style="font-size: 22px;font-weight: bold;margin-top: 12px;margin-bottom: 15px;">Login</h1></td>
                                                        </tr>
                                                        <tr>
                                                            <td width="60"></td>
                                                            <td style="padding-top: 15px;padding-bottom: 15px;color: #333333;">
                                                                <p>
                                                                    Esta área é destinada somente a administradores do site. Caso não tenha um login, solicite um à um administrador válido.
                                                                </p>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td style="padding:5px;"><input type="password" name="senha" value="" size="25" /></td>
                                                        </tr>
                                                        <tr>
                                                            <td></td>
                                                            <td style="padding:5px;">
                                                                <input type="submit" value="Entrar" name="bt_acao" class="botao" />
                                                                <?=anchor('admin/index/recuperar','Recuperar senha');?>
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                </table>
