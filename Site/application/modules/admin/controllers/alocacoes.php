 ...
 * o controller da tabela alocacoes 
 * 
 * @package CMS 
...
class alocacoes extends MX_Controller { 

    private $painel_name = 'alocacoes';
    ...
    /**
     * Este método mostra a lista de registros da tabela alocacoes.
     * 
     * @access public 
     * @author Gerado automaticamente <contato@elieldepaula.com.br> 
     * @return boolean 
    ...
    public function index() {
        ...
        $total_registros = $this->alocacoes_model->count_all();
        $config['total_rows'] = $total_registros;
        $config['per_page'] = $limit;
        $config['uri_segment'] = $uri_segment;
        $this->pagination->initialize($config);
        $dados_painel['msg'] = $this->session->flashdata('feedback');
        $dados_painel['lista'] = $this->alocacoes_model->get_paged_list($limit, $offset)->result();
    ...
    /**
     * Este método exibe o formulário de cadastro da tabela alocacoes.
     * 
     * @access public 
     * @author Gerado automaticamente <contato@elieldepaula.com.br> 
     * @return boolean 
    ...
    /**
     * Este método exibe o formulário de alteração da tabela alocacoes.
     * 
     * @access public 
     * @author Gerado automaticamente <contato@elieldepaula.com.br> 
     * @return boolean 
    ...
    public function update($id = ''){
        ...
        $dados_painel['modo'] = 'update';
        	$dados_painel['row'] = $this->alocacoes_model->get_by_id($id)->row();
        	$this->template->load('main_view', $this->painel_name.'_view', $dados_painel);
    }

    /**
     * Este método salva o registro na tabela alocacoes.
    ...
    public function save($id = '') {
        ...
        $dados_save['cod_hospede'] = $_POST['cod_hospede'];
        $dados_save['cod_apartamento'] = $_POST['cod_apartamento'];
        if($id):
            if($this->alocacoes_model->update($id, $dados_save)):
            ...
            if($this->alocacoes_model->save($dados_save)):
                $this->session->set_flashdata('feedback', 'Dados salvos com sucesso!');
                redirect('admin/'.$this->painel_name);
            else:
                $this->session->set_flashdata('feedback', 'Erro ao salvar os dados');
    ...
    /**
     * Este método exclui um registro da tabela alocacoes.
     * 
     * @access public 
     * @author Gerado automaticamente <contato@elieldepaula.com.br> 
     * @return boolean 
    ...
    public function delete($id) {
        if($this->alocacoes_model->delete($id)):
