 ...
 * o controller da tabela ligacoes 
 * 
 * @package CMS 
...
class ligacoes extends MX_Controller { 

    private $painel_name = 'ligacoes';
    ...
    /**
     * Este método mostra a lista de registros da tabela ligacoes.
     * 
     * @access public 
     * @author Gerado automaticamente <contato@elieldepaula.com.br> 
     * @return boolean 
    ...
    public function index() {
        ...
        $total_registros = $this->ligacoes_model->count_all();
        $config['total_rows'] = $total_registros;
        $config['per_page'] = $limit;
        $config['uri_segment'] = $uri_segment;
        $this->pagination->initialize($config);
        $dados_painel['msg'] = $this->session->flashdata('feedback');
        $dados_painel['lista'] = $this->ligacoes_model->get_paged_list($limit, $offset)->result();
    ...
    /**
     * Este método exibe o formulário de cadastro da tabela ligacoes.
     * 
     * @access public 
     * @author Gerado automaticamente <contato@elieldepaula.com.br> 
     * @return boolean 
    ...
    /**
     * Este método exibe o formulário de alteração da tabela ligacoes.
     * 
     * @access public 
     * @author Gerado automaticamente <contato@elieldepaula.com.br> 
     * @return boolean 
    ...
    public function update($id = ''){
        ...
        $dados_painel['modo'] = 'update';
        	$dados_painel['row'] = $this->ligacoes_model->get_by_id($id)->row();
        	$this->template->load('main_view', $this->painel_name.'_view', $dados_painel);
    }

    /**
     * Este método salva o registro na tabela ligacoes.
    ...
    public function save($id = '') {
        ...
        $dados_save['inicio'] = $_POST['inicio'];
        $dados_save['fim'] = $_POST['fim'];
        $dados_save['valor'] = $_POST['valor'];
        if($id):
            if($this->ligacoes_model->update($id, $dados_save)):
            ...
            if($this->ligacoes_model->save($dados_save)):
                $this->session->set_flashdata('feedback', 'Dados salvos com sucesso!');
                redirect('admin/'.$this->painel_name);
            else:
                $this->session->set_flashdata('feedback', 'Erro ao salvar os dados');
    ...
    /**
     * Este método exclui um registro da tabela ligacoes.
     * 
     * @access public 
     * @author Gerado automaticamente <contato@elieldepaula.com.br> 
     * @return boolean 
    ...
    public function delete($id) {
        if($this->ligacoes_model->delete($id)):
