 ...
 * o gerenciamento da tabela consumos 
 * 
 * @package CMS 
...
class consumos_model extends CI_Model { 
    ...
    private $tabela = 'consumos';
    private $primary_key = 'cod_consumo';
    ...
    /**
     * Este método lista todos os resultados da tabela consumos.
     * 
     * @access public 
     * @author Gerado automaticamente <contato@elieldepaula.com.br> 
     * @return boolean 
    ...
    /**
     * Este método faz a contagem de todos os registros da tabela consumos.
     * 
     * @access public 
     * @author Gerado automaticamente <contato@elieldepaula.com.br> 
     * @return boolean 
    ...
    /**
     * Este método recupera uma consulta com paginação da tabela consumos.
     * 
     * @access public 
     * @author Gerado automaticamente <contato@elieldepaula.com.br> 
     * @return boolean 
    ...
    /**
     * Este método recupera um registro da tabela consumos.
     * 
     * @access public 
     * @author Gerado automaticamente <contato@elieldepaula.com.br> 
     * @return boolean 
    ...
    /**
     * Este método salva um registro na tabela consumos.
     * 
     * @access public 
     * @author Gerado automaticamente <contato@elieldepaula.com.br> 
     * @return boolean 
    ...
    /**
     * Este método atualiza um registro na tabela consumos.
     * 
     * @access public 
     * @author Gerado automaticamente <contato@elieldepaula.com.br> 
     * @return boolean 
    ...
    /**
     * Este método retorna o relacionamento da tabela consumos.
     * 
     * @access public 
     * @author Gerado automaticamente <contato@elieldepaula.com.br> 
     * @return boolean 
