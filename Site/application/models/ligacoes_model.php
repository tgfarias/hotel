 ...
 * o gerenciamento da tabela ligacoes 
 * 
 * @package CMS 
...
class ligacoes_model extends CI_Model { 
    ...
    private $tabela = 'ligacoes';
    private $primary_key = 'cod_ligacao';
    ...
    /**
     * Este método lista todos os resultados da tabela ligacoes.
     * 
     * @access public 
     * @author Gerado automaticamente <contato@elieldepaula.com.br> 
     * @return boolean 
    ...
    /**
     * Este método faz a contagem de todos os registros da tabela ligacoes.
     * 
     * @access public 
     * @author Gerado automaticamente <contato@elieldepaula.com.br> 
     * @return boolean 
    ...
    /**
     * Este método recupera uma consulta com paginação da tabela ligacoes.
     * 
     * @access public 
     * @author Gerado automaticamente <contato@elieldepaula.com.br> 
     * @return boolean 
    ...
    /**
     * Este método recupera um registro da tabela ligacoes.
     * 
     * @access public 
     * @author Gerado automaticamente <contato@elieldepaula.com.br> 
     * @return boolean 
    ...
    /**
     * Este método salva um registro na tabela ligacoes.
     * 
     * @access public 
     * @author Gerado automaticamente <contato@elieldepaula.com.br> 
     * @return boolean 
    ...
    /**
     * Este método atualiza um registro na tabela ligacoes.
     * 
     * @access public 
     * @author Gerado automaticamente <contato@elieldepaula.com.br> 
     * @return boolean 
    ...
    /**
     * Este método retorna o relacionamento da tabela ligacoes.
     * 
     * @access public 
     * @author Gerado automaticamente <contato@elieldepaula.com.br> 
     * @return boolean 
