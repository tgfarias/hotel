 ...
 * o gerenciamento da tabela apartamentos 
 * 
 * @package CMS 
...
class apartamentos_model extends CI_Model { 
    ...
    private $tabela = 'apartamentos';
    private $primary_key = 'cod_apartamento';
    ...
    /**
     * Este método lista todos os resultados da tabela apartamentos.
     * 
     * @access public 
     * @author Gerado automaticamente <contato@elieldepaula.com.br> 
     * @return boolean 
    ...
    /**
     * Este método faz a contagem de todos os registros da tabela apartamentos.
     * 
     * @access public 
     * @author Gerado automaticamente <contato@elieldepaula.com.br> 
     * @return boolean 
    ...
    /**
     * Este método recupera uma consulta com paginação da tabela apartamentos.
     * 
     * @access public 
     * @author Gerado automaticamente <contato@elieldepaula.com.br> 
     * @return boolean 
    ...
    /**
     * Este método recupera um registro da tabela apartamentos.
     * 
     * @access public 
     * @author Gerado automaticamente <contato@elieldepaula.com.br> 
     * @return boolean 
    ...
    /**
     * Este método salva um registro na tabela apartamentos.
     * 
     * @access public 
     * @author Gerado automaticamente <contato@elieldepaula.com.br> 
     * @return boolean 
    ...
    /**
     * Este método atualiza um registro na tabela apartamentos.
     * 
     * @access public 
     * @author Gerado automaticamente <contato@elieldepaula.com.br> 
     * @return boolean 
    ...
    /**
     * Este método retorna o relacionamento da tabela apartamentos.
     * 
     * @access public 
     * @author Gerado automaticamente <contato@elieldepaula.com.br> 
     * @return boolean 
